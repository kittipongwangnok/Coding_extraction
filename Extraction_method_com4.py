...
#Print the data#1
Extraction_method_com4 = []
print ('--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------')
print ('No. \t\t MJD  \t I_Tar \t II_Tar III_Tar IV_Tar I_Ref \t\t II_Ref \t III_Ref \t IV_Ref        I_Chk1 II_Chk1 III_Chk1 IV_Chk1 I_Chk2 II_Chk2 III_Chk2 IV_Chk2 I_Chk3 II_Chk3 III_Chk3 IV_Chk3')
print ('--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------')
for i in range(len(x)):
        print ('%0.0f\t%0.7f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f'
        %(i, x[i], I_tar[i], II_tar[i], III_tar[i], IV_tar[i], I_ref[i], II_ref[i], III_ref[i], IV_ref[i], I_chk1[i], II_chk1[i], III_chk1[i], IV_chk1[i], I_chk2[i], II_chk2[i], III_chk2[i], IV_chk2[i], I_chk3[i], II_chk3[i], III_chk3[i], IV_chk3[i]))
        Extraction_method_com4.append('%0.0f\t%0.14f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f'
        %(i, x[i], I_tar[i], II_tar[i], III_tar[i], IV_tar[i], I_ref[i], II_ref[i], III_ref[i], IV_ref[i], I_chk1[i], II_chk1[i], III_chk1[i], IV_chk1[i], I_chk2[i], II_chk2[i], III_chk2[i], IV_chk2[i], I_chk3[i], II_chk3[i], III_chk3[i], IV_chk3[i]))

extraction_method = Extraction_method_com4
f = open('Extraction_method_com4.txt', 'w')
