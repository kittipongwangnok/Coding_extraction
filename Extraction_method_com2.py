...
#Print the data#1
Extraction_method_com2 = []
print ('---------------------------------------------------------------------------------------------------------------------------------------------')
print ('No.             MJD             I_Tar   II_Tar     I_Ref        II_Ref          I_Chk1  II_Chk1  I_Chk2 II_Chk2  I_Chk3 II_Chk3')
print ('---------------------------------------------------------------------------------------------------------------------------------------------')
for i in range(len(x)):
        print ('%0.0f\t%0.14f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f'
        %(i, x[i], I_tar[i], II_tar[i], I_ref[i], II_ref[i], I_chk1[i], II_chk1[i], I_chk2[i], II_chk2[i], I_chk3[i], II_chk3[i]))
        Extraction_method_com2.append('%0.0f\t%0.14f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f\t%0.1f'
        %(i, x[i], I_tar[i], II_tar[i], I_ref[i], II_ref[i], I_chk1[i], II_chk1[i], I_chk2[i], II_chk2[i], I_chk3[i], II_chk3[i]))

extraction_method = Extraction_method_com2
f = open('Extraction_method_com2.txt', 'w')
